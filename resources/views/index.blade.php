...
<div class="container mx-auto px-4 pt-16">
    <div class="popular-movies">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            <div class="mt-8">
                <a href="#">
                    <img src="/img/132202400_2821708451440361_4345491795675412315_n.jpg" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150">
                </a>
                <div class="mt-2">
                    <a href="#" class="text-lg mt-2 hover:text-gray-300">medo</a>
                    ...
                    <div class="text-gray-400 text-sm">ldsjk</div>
                </div>
            </div>
